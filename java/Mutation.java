...
public class Mutation {
	...
	public static Genetic_algorithm constrained_route_reversal_mutation(Genetic_algorithm ga, Load_problem load, Particle_swarm para) {
		...
		for (int i=0; i<ga.pool.size(); i++) {
			d = Math.random();
			if (d<para.cr_para.get(i).get(1)) {  //Crossover occers
